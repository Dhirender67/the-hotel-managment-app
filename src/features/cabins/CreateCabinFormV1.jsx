...
import { addNewCabins } from "../../services/apiCabins";
...
function CreateCabinForm() {
  ...
  function onSubmit(data) {
    console.log(data);
    mutate({ ...data, images: data.images[0] });
  }
      ...
      <div className="max-w-3xl mt-3 mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <form onSubmit={handleSubmit(onSubmit, onError)}>
          ...
          <div className="feild-row">
            ...
            <input
              id="images"
              {...register("images", { required: "This feild is required" })}
              type="file"
          ...
          <div className="flex justify-end gap-3 px-6 py-4">
            <Button variation="ternary" type="reset">
              Cancel
            </Button>
